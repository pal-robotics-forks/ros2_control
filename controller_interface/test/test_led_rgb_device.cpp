...
TEST_F(LedDeviceTest, validate_all)
{
  ...
  hardware_interface::CommandInterface::SharedPtr led_r =
    std::make_shared<hardware_interface::CommandInterface>(
      device_name_, interface_names_[0], &led_values_[0]);
  hardware_interface::CommandInterface::SharedPtr led_g =
    std::make_shared<hardware_interface::CommandInterface>(
      device_name_, interface_names_[1], &led_values_[1]);
  hardware_interface::CommandInterface::SharedPtr led_b =
    std::make_shared<hardware_interface::CommandInterface>(
