...
TEST_F(SemanticComponentInterfaceTest, validate_state_interfaces)
{
  ...
  hardware_interface::StateInterface::ConstSharedPtr interface_1 =
    std::make_shared<const hardware_interface::StateInterface>(
      component_name_, "1", &interface_values[0]);
  hardware_interface::StateInterface::ConstSharedPtr interface_3 =
    std::make_shared<const hardware_interface::StateInterface>(
      component_name_, "3", &interface_values[1]);
  hardware_interface::StateInterface::ConstSharedPtr interface_5 =
    std::make_shared<const hardware_interface::StateInterface>(
