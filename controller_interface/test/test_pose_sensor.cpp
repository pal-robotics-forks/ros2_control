...
TEST_F(PoseSensorTest, validate_all)
{
  ...
  hardware_interface::StateInterface::ConstSharedPtr position_x =
    std::make_shared<const hardware_interface::StateInterface>(
      sensor_name_, interface_names_[0], &position_values_[0]);
  hardware_interface::StateInterface::ConstSharedPtr position_y =
    std::make_shared<const hardware_interface::StateInterface>(
      sensor_name_, interface_names_[1], &position_values_[1]);
  hardware_interface::StateInterface::ConstSharedPtr position_z =
    std::make_shared<const hardware_interface::StateInterface>(
